    ...
    <section className="hero">
      <div className="container h-100 d-flex flex-column justify-content-between py-4">
        <div className="row h-100">
          <div className="col-lg-7 col-md-10 col-sm-12 d-flex flex-column justify-content-center align-items-start animated bounceInLeft">
            ...
            <Link to="/contacto" className="btn rounded mt-3 bg-transparent border shadow animated fadeIn delay-1s">
              Contactar ahora
            </Link>
          </div>
